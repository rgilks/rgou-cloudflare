...
#[test]
fn test_quick_matrix_verification() {
    println!("🔧 QUICK MATRIX VERIFICATION");
    println!("{}", "=".repeat(60));
    println!("Testing if matrix fixes work correctly");
    ...
    println!("✅ Quick verification complete!");
}
...
fn test_emm2_vs_heuristic() {
    ...
    let emm_rate = (emm_wins as f64 / QUICK_GAMES as f64) * 100.0;
    println!(
...
fn test_genetic_vs_heuristic() {
    ...
    let genetic_rate = (genetic_wins as f64 / QUICK_GAMES as f64) * 100.0;
    println!(
    ...
    if genetic_rate > 50.0 {
        println!("  ✅ Genetic AI performs as expected (improvement over heuristic)");
    } else {
        println!("  ❌ Genetic AI underperforming (should improve over heuristic)");
    }
}
...
fn test_random_vs_heuristic() {
    ...
    let random_rate = (random_wins as f64 / QUICK_GAMES as f64) * 100.0;
    println!(
